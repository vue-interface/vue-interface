...
/* harmony default export */ var src_FormControl = ({
  ...
  computed: {
    ...
    formGroupClasses: function formGroupClasses() {
      ...
      var name = prefix_prefix(kebabCase(this.componentName), this.custom ? CUSTOM_PREFIX : '');
      return _ref = {}, _defineProperty(_ref, name, !!name), _defineProperty(_ref, prefix_prefix(this.size, name), !!(name && this.size)), _defineProperty(_ref, 'form-group', this.group), _defineProperty(_ref, 'has-activity', this.activity), _defineProperty(_ref, 'has-changed', this.hasChanged), _defineProperty(_ref, 'has-focus', this.hasFocus), _defineProperty(_ref, 'is-empty', this.isEmpty), _defineProperty(_ref, 'is-invalid', !!(this.invalid || this.invalidFeedback)), _defineProperty(_ref, 'is-valid', !!(this.valid || this.validFeedback)), _ref;
    },
