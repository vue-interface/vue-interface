...
<template>
    <div class="">
        ...
        <div class="w-24 bg-gray-100 p-3 mb-3">
            Value: {{ value }}
        </div>
    </div>

    <div class="flex gap-8 items-center justify-center">
        <div class="p-8 rounded-md bg-neutral-100 w-1/3">
            ...
            <select-field
                ...
                help-text="This field uses an empty option for a label..."
                class="mb-3">
                <option value="">
                    This field shows the empty option by default.
                </option>
                <option value="1">
                    Option 1
                </option>
